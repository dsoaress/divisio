  ...
  if (collapsible === 'none') {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          'z-[1700] flex h-full w-(--sidebar-width) flex-col bg-sidebar text-sidebar-foreground',
          className
        )}
        {...props}
      >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'fixed inset-y-0 z-[1700] hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex',
          side === 'left'
